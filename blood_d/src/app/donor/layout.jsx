...
import { LayoutDashboard, User, History, Tent, LogOut, Bell } from "lucide-react";
            ...
            <aside className="w-64 bg-white border-r border-gray-100 flex flex-col fixed h-full z-10">
                ...
                <div className="p-4">
                    ...
                    <nav className="space-y-1">
                        <NavItem href="/donor" icon={LayoutDashboard} label="Dashboard" active />
                        <NavItem href="/donor/profile" icon={User} label="My Profile" />
                        <NavItem href="/donor/history" icon={History} label="Donation History" />
                        <NavItem href="/donor/camps" icon={Tent} label="Blood Camps" />
                    </nav>
                </div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3 pl-6 border-l border-gray-100">
                            ...
                            <div className="hidden md:block">
                                <span className="text-sm font-bold text-gray-900 block leading-none">suraj</span>
