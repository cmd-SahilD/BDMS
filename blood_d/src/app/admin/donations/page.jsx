...
export default function AdminDonationsPage() {
    ...
    const filteredDonations = donations.filter(donation => {
        ...
        const locationName = donation.location || "";
        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                        ...
                        System <span className="text-red-600">Donation History</span>
                    </h1>
                    <p className="text-gray-500 text-sm mt-1">Full audit log of all blood donations across all facilities</p>
                </div>
            ...
            {loading ? (
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Location / Facility</th>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center text-gray-500 shadow-sm">
                    ...
                    <p className="text-sm">Global donation history is currently empty.</p>
                </div>
            )}
        </div>
    );
