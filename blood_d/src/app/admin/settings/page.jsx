    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                ...
                <p className="text-gray-500 mt-1">Manage administrative security preferences</p>
            </div>
    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                />
                {onToggle && (
                    <button type="button" onClick={onToggle} className="absolute right-4 top-4 text-gray-400 hover:text-gray-600 px-1">
