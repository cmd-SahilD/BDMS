...
import { LayoutDashboard, Beaker, Users, Tent, FileText, UserCircle, LogOut, History, Bell, ChevronDown, Settings } from "lucide-react";
                                    ...
                                    <div className="absolute top-full right-0 mt-2 w-80 bg-white border border-gray-100 rounded-2xl shadow-xl z-20 overflow-hidden">
                                        ...
                                        {notifications.length > 0 && (
                                            <div className="px-4 py-2 border-t border-gray-50 bg-gray-50">
                                                <button onClick={refreshNotifications} className="w-full text-center text-xs text-red-600 font-bold hover:text-red-700">
                                                    Refresh
                                                </button>
                                            </div>
                                        )}
                                ...
                                <>
                                    ...
                                    <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-gray-100 rounded-xl shadow-lg py-2 z-20">
                                        ...
                                        <div className="border-t border-gray-50 p-1 mt-1">
                                            <button onClick={logout} className="flex items-center gap-3 w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors">
